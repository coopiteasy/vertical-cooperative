...
renamed_group_xml_ids = (
    ...
    ("easy_my_coop.group_easy_my_coop_manager", "cooperator.cooperator_group_manager"),
)
...
renamed_template_xml_ids = [
    ("easy_my_coop.emc_external_layout_standard", "cooperator.external_layout_standard")
]
...
def migrate(env, version):
    ...
    module_ids = env["ir.module.module"].search(
        [("name", "=", "cooperator"), ("state", "=", "uninstalled")]
    )
    if module_ids:
